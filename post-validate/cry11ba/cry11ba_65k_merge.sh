...
filter.unit_cell.cluster.covariance.file=${MODULES}/exafel_project/kpp-frontier/cry11ba/covariance_tdata_cells_20000.pickle # ${DIALS_OUTPUT}/covariance_tdata_cells.pickle
