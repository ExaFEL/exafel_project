...
sbatch -J$job $GPU -t 50 -o${odir}/sim.out -e${odir}/sim.err ./general_sim.sh $sample $length $nshot $detdist $pdb $odir
...
sbatch -J$job $GPU -t 60 -o${odir}/st1.out -e${odir}/st1.err ./general_stage1_restraints_3fold.sh $ucell $spcgrp $odir ${n_unrestrain}
