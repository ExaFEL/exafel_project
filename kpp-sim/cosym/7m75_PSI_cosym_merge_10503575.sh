...
export OUT_DIR=${PWD}
export DIALS_OUTPUT=${SCRATCH}/ferredoxin_sim/10478144
...
filter.unit_cell.cluster.covariance.file=/global/cfs/cdirs/lcls/sauter/LY99/high_remote_sim/covariance_tdata_cells_7M75.pickle
...
scaling.model=/global/cfs/cdirs/lcls/sauter/LY99/high_remote_sim/7m75.pdb
