...
#SBATCH -J 65k_256N      # job name
#SBATCH -A CHM137        # allocation
#SBATCH -p batch
#SBATCH -t 120
#SBATCH -o %j.out
#SBATCH -e %j.err
export SRUN="srun -N 256 -n 4096 -c2"
...
echo \"running stage 2 on 65k lysozyme images with command $SRUN\"
$SRUN simtbx.diffBragg.stage_two stage_two.phil \
io.output_dir=${SLURM_JOB_ID}_job${job} \
pandas_table=$PANDA num_devices=$PERL_NDEV max_process=65500 \
