...
#SBATCH -J 262k_128N     # job name
#SBATCH -A CHM137        # allocation
#SBATCH -p batch
#SBATCH -t 120
#SBATCH -o %j.out
#SBATCH -e %j.err
export SRUN="srun -N 128 -n 2048 -c2"
...
echo \"running stage 2 on 262k lysozyme images with command $SRUN\"
$SRUN simtbx.diffBragg.stage_two stage_two.phil \
io.output_dir=${SLURM_JOB_ID}_job${job} \
pandas_table=$PANDA num_devices=$PERL_NDEV max_process=262000 \
