...
predictions {
  ...
  resolution_range = [2.3,999]
  symbol_override = P21212
...
indexing.known_symmetry.unit_cell=168.245,158.528,57.534,90,90,90
indexing.known_symmetry.space_group=P21212
...
$SCRATCH/cry11ba/$JOB_ID_HOPPER/stage1 \
predict \
--cmdlinePhil oversample_override=1 \
Nabc_override=[28,28,28] threshold=1 label_weak_col=rlp \
--numdev 8
